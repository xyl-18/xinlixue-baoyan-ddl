...
export const programs: Program[] = [
  ...
  current({ id: 'scnu-ibrr-2027', school: '华南师范大学', institute: '脑科学与康复医学研究院', title: '2027 年推免接收信息（待研究院公布）', type: '推免接收', tiers: ['211', '双一流'], province: '广东', degrees: ['学术型硕士', '直博'], directions: ['认知神经', '基础心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: '该研究院作为独立招生单位单列跟踪，不与心理学院合并。尚未检索到 2027 年具体推免通知和截止时间。', requirements: ['关注研究院官方通知', '以研究院当年度招生专业和推免办法为准'], sourceUrl: 'https://ibrr.scnu.edu.cn/' }),
  ...
  current({ id: 'sjtu-2027', school: '上海交通大学', institute: '心理学院', title: '2027 年推免接收信息（待学院公布）', type: '推免接收', tiers: ['985', '211', '双一流'], province: '上海', degrees: ['学术型硕士', '直博'], directions: ['基础心理', '认知神经', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: '学院尚未发布 2027 推免接收办法。已确认自 2027 年起停止招收全日制应用心理专硕，当前按心理学学硕与直博方向持续跟踪。', requirements: ['关注心理学院招生信息栏目', '注意 2027 年全日制应用心理专硕停招调整'], sourceUrl: 'https://psychology.sjtu.edu.cn/zsxx.html' }),
  current({ id: 'bsu-2027', school: '北京体育大学', institute: '心理学院', title: '2027 年推免接收信息（待学院公布）', type: '推免接收', tiers: ['211', '双一流'], province: '北京', degrees: ['学术型硕士', '应用心理专硕'], directions: ['基础心理', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['重点关注运动认知与运动健康心理方向', '以学校 2027 专业目录和接收办法为准'], sourceUrl: 'https://zs.bsu.edu.cn/' }),
  current({ id: 'cugb-2027', school: '中国地质大学（北京）', institute: '马克思主义学院心理学专业', title: '2027 年接收推免研究生（含直博生）', type: '推免接收', tiers: ['211', '双一流'], province: '北京', degrees: ['学术型硕士', '直博'], directions: ['发展教育', '应用心理'], openAt: '2026-09-04T00:00:00+08:00', deadline: null, deadlinePrecision: 'unknown', eventDates: '各学院自定，复试最晚 10 月 10 日前完成', description: '学校系统自 9 月 4 日起开放，具体截止时间见各学院通知；除全日制工商管理外，其他全日制专业均可接收推免。', requirements: ['须获得推免资格', '在学校推免服务系统上传材料'], sourceUrl: 'https://bm.cugb.edu.cn/yjsyzsb/c/2026-09-03/856199.shtml' }),
  current({ id: 'tmu-2027', school: '天津医科大学', institute: '应用心理专业', title: '2027 年推免接收信息（待学校公布）', type: '推免接收', tiers: ['211', '双一流'], province: '天津', degrees: ['应用心理专硕'], directions: ['临床咨询', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注学校研究生院招生栏目', '医学相关培养要求以 2027 目录为准'], sourceUrl: 'https://gs.tmu.edu.cn/' }),
  current({ id: 'hrbeu-2027', school: '哈尔滨工程大学', institute: '人文社会科学学院心理学专业', title: '2027 年推免接收信息（待学院公布）', type: '推免接收', tiers: ['211', '双一流'], province: '黑龙江', degrees: ['学术型硕士'], directions: ['基础心理', '临床咨询', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注学校研招网和人文学院通知', '最终专业以 2027 招生目录为准'], sourceUrl: 'https://yzb.hrbeu.edu.cn/' }),
  current({ id: 'hhu-2027', school: '河海大学', institute: '公共管理学院心理学系', title: '2027 年接收校内外推免生预报名', type: '预推免', tiers: ['211', '双一流'], province: '江苏', degrees: ['学术型硕士'], directions: ['社会心理', '应用心理'], openAt: '2026-07-10T00:00:00+08:00', deadline: null, deadlinePrecision: 'unknown', eventDates: '学院后续通知', description: '学校已发布 2027 推免预报名公告，但公开网页未提供可稳定提取的截止时刻；心理学专业请以报名系统和公共管理学院通知为准。', requirements: ['预计取得推免资格', '按学校预报名系统提交申请'], sourceUrl: 'https://gs.hhu.edu.cn/2026/0710/c17279a331447/page.htm' }),
  current({ id: 'jnu-2027', school: '暨南大学', institute: '管理学院心理学系', title: '2027 年推免接收信息（待学院公布）', type: '推免接收', tiers: ['211', '双一流'], province: '广东', degrees: ['学术型硕士'], directions: ['应用心理', '临床咨询', '认知神经'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注暨南大学研招网及管理学院通知', '最终专业以 2027 招生目录为准'], sourceUrl: 'https://yz.jnu.edu.cn/' }),
  current({ id: 'swjtu-2027', school: '西南交通大学', institute: '心理研究与咨询中心', title: '2027 年推免接收信息（待中心公布）', type: '推免接收', tiers: ['211', '双一流'], province: '四川', degrees: ['学术型硕士'], directions: ['应用心理', '发展教育', '心理统计'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注学校研招网及心理研究与咨询中心通知', '最终专业与名额以 2027 目录为准'], sourceUrl: 'https://yz.swjtu.edu.cn/' }),
  current({ id: 'nwu-2027', school: '西北大学', institute: '公共管理学院应用心理学专业', title: '2027 年推免接收信息（待学校公布）', type: '推免接收', tiers: ['211', '双一流'], province: '陕西', degrees: ['学术型硕士'], directions: ['应用心理', '社会心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注西北大学研究生院推免栏目', '最终专业以 2027 招生目录为准'], sourceUrl: 'https://yjs.nwu.edu.cn/' }),
  current({ id: 'fmmu-2027', school: '空军军医大学', institute: '军事医学心理学系', title: '2027 年推免接收信息（待学校公布）', type: '推免接收', tiers: ['211', '双一流'], province: '陕西', degrees: ['学术型硕士', '应用心理专硕'], directions: ['临床咨询', '社会心理', '认知神经'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: '军事院校报考身份、军籍和定向要求可能与普通高校不同；截至核验日未找到 2027 院系截止时间，请以军校官方招生章程为准。', requirements: ['先核对军地考生身份要求', '关注学校研究生院正式招生通知'], sourceUrl: 'https://www.fmmu.edu.cn/yjsy/' }),
  current({ id: 'nxu-2027', school: '宁夏大学', institute: '心理学相关培养单位', title: '2027 年推免接收信息（待学校公布）', type: '推免接收', tiers: ['211', '双一流'], province: '宁夏', degrees: ['学术型硕士'], directions: ['社会心理', '发展教育', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注宁夏大学研究生院招生栏目', '最终专业以 2027 招生目录为准'], sourceUrl: 'https://graduate.nxu.edu.cn/' }),
  current({ id: 'smmu-2027', school: '海军军医大学', institute: '应用心理专业', title: '2027 年推免接收信息（待学校公布）', type: '推免接收', tiers: ['211', '双一流'], province: '上海', degrees: ['应用心理专硕'], directions: ['临床咨询', '认知神经', '应用心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: '军事院校部分培养类型可能限军队在职干部或有军地分类要求；请先核对 2027 招生章程后再申请。', requirements: ['核对军地考生与学习方式限制', '关注学校招生办公室正式通知'], sourceUrl: 'https://ao.smmu.edu.cn/' }),
  current({ id: 'fzu-2027', school: '福州大学', institute: '人文社会科学学院心理学系', title: '2027 年推免接收信息（待学院公布）', type: '推免接收', tiers: ['211', '双一流'], province: '福建', degrees: ['学术型硕士'], directions: ['认知神经', '社会心理', '临床咨询', '工程心理'], openAt: null, deadline: null, deadlinePrecision: 'unknown', eventDates: '待公布', description: pending, requirements: ['关注福州大学研究生院及人文学院通知', '最终专业以 2027 招生目录为准'], sourceUrl: 'https://yjsy.fzu.edu.cn/' }),
